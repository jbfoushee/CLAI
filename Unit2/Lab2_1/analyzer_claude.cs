...
/// Equivalent to a dictionary row structure in Python.
/// </summary>
public record SalesItem(string ProductName, decimal Price, int Quantity);

/// <summary>
/// SalesAnalyzer class provides comprehensive analysis of sales data from CSV files.
/// It loads sales data, calculates total revenue, and identifies top-performing products.
/// </summary>
